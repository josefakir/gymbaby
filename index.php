	...
	<div id="content" class="w100">
		<div class="container">
			...
			<div class="one-third column">
				...
				<p class="phome"> <a href="mailto:contacto@gymbabyathome.com" class="ahome">contacto@gymbabyathome.com</a> </p>
				<p class="phome">044 55 38 35 15 65 (disponible whatsapp)</p>
			</div>
			<div class="clear"></div>
		</div>
	</div>
